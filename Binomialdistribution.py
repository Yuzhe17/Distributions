...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, size=20):
        ...
        #               variable.   
        """Function called when an object instance is created
        
        Args:
          prob(int): the probability of getting a positive outcome
          size(int): the number of trials performed 
    ...
    def plot_bar(self):
        ...
        plt.xlabel('outcome')
        plt.ylabel('count')
        plt.title('histogram of the data list')        
    ...
    def pdf(self, k):
        ...
        combinations_number=math.factorial(self.n)/(math.factorial(k)*math.factorial(self.n-k))        
        combination_probability=math.pow(self.p,k)*math.pow((1-self.p),(self.n-k))
        return combination_probability*combinations_number
    ...
    def plot_bar_pdf(self):
        ...
        plt.title('probability function of the binomial distribution')
        return x,y
    ...
    def __repr__(self):
        ...
        return 'mean {0}, standard deviation {1}, p {2}, n {3}'.format(self.mean, self.stdev, self.p, self.n)
